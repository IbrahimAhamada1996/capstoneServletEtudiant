        ...
        <div class="col">
            <div class="card">
                <div class="card-header bg-primary text-white">
                    <div class="title"><h1 class=" text-center">Add Student of 6 or 16 Month </h1></div>
                </div>
                <div class="card-body">
                    <form action="" method="post">
                        ...
                        <div class="form-group">
                            <label for="registrationDate">trainingDuration:</label>
                            <select class="form-group" name="trainingDuration">
