    ...
    <div class="row">
        <nav>
            <ul class="nav">
                <li class="nav-item">
                    <form method="post">
                        <button type="submit"> <a class="nav-link" href="/home/admin6/create">Create</a></button>
                    </form>
        ...
        <div class="col">
            <div class="card">
                <div class="card-header bg-primary text-white">
                    <div class="title"><h1 class=" text-center">Add Student of 16 Month</h1></div>
                </div>
                <div class="card-body">
                    <form action="" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="Enter registrationDate" id="registrationDate" name="registrationDate">
                        </div>
