...
@WebServlet(name = "StudentListServlet", value = "/home/admin/list")
...
//        System.out.println(studentService.getStudent());
        ...
        req.getRequestDispatcher("/WEB-INF/view/admin/list.jsp").forward(req,resp);
    }
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
      ...
      String idUpdate = req.getParameter("update");
        ...
        if(firstname!=null && lasttname!=null&&dateOfBirth!=null&&registrationDate!=null){
            ...
            req.getRequestDispatcher("/WEB-INF/view/admin/update.jsp").forward(req,resp);
        }
